...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 47156930, ; hash 0x2cf8ec2, from name: panoh v2
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 491768478, ; hash 0x1d4fca9e, from name: libaot-panoh v2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-panoh v2.dll.so
		ptr null; void* handle (0x0)
	}, ; 53
	...
	%struct.DSOCacheEntry {
		i64 2032078831, ; hash 0x791f0fef, from name: aot-panoh v2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-panoh v2.dll.so
		ptr null; void* handle (0x0)
	}, ; 217
	...
	%struct.DSOCacheEntry {
		i64 2075738887, ; hash 0x7bb94307, from name: panoh v2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-panoh v2.dll.so
		ptr null; void* handle (0x0)
	}, ; 224
	...
	%struct.DSOCacheEntry {
		i64 2533517390, ; hash 0x9702684e, from name: aot-panoh v2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-panoh v2.dll.so
		ptr null; void* handle (0x0)
	}, ; 282
	...
	%struct.DSOCacheEntry {
		i64 2562246056, ; hash 0x98b8c5a8, from name: libaot-panoh v2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-panoh v2.dll.so
		ptr null; void* handle (0x0)
	}, ; 285
