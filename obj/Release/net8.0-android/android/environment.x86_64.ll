...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 4065573914267051003, ; hash 0x386bd1ef47fb63fb, from name: libaot-panoh v2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-panoh v2.dll.so
		ptr null; void* handle (0x0)
	}, ; 103
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 9446687150443267410, ; hash 0x83195fe9a26b0552, from name: libaot-panoh v2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-panoh v2.dll.so
		ptr null; void* handle (0x0)
	}, ; 236
	...
	%struct.DSOCacheEntry {
		i64 9939344348959781572, ; hash 0x89efa5064408b2c4, from name: panoh v2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-panoh v2.dll.so
		ptr null; void* handle (0x0)
	}, ; 248
	...
	%struct.DSOCacheEntry {
		i64 13711430869714704449, ; hash 0xbe48c9bacfab9841, from name: aot-panoh v2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-panoh v2.dll.so
		ptr null; void* handle (0x0)
	}, ; 353
	...
	%struct.DSOCacheEntry {
		i64 16145413812127671236, ; hash 0xe0100851ef8e23c4, from name: aot-panoh v2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-panoh v2.dll.so
		ptr null; void* handle (0x0)
	}, ; 418
	...
	%struct.DSOCacheEntry {
		i64 16596060996203391112, ; hash 0xe6510d8bdd6b2888, from name: panoh v2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-panoh v2.dll.so
		ptr null; void* handle (0x0)
	}, ; 431
...
@.env.3 = private unnamed_addr constant [37 x i8] c"0d95b397-7f64-4147-affd-2ced40ad675d\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.companyname.panohv2\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [23 x i8] c"libaot-panoh v2.dll.so\00", align 16
